...
/* Private defines -----------------------------------------------------------*/
#define LED_TARGET_Pin GPIO_PIN_13
#define LED_TARGET_GPIO_Port GPIOC
#define LORA_DIO1_Pin GPIO_PIN_2
#define LORA_DIO1_GPIO_Port GPIOB
#define LORA_TXN_Pin GPIO_PIN_13
#define LORA_TXN_GPIO_Port GPIOB
...
#define LORA_RXN_Pin GPIO_PIN_4
#define LORA_RXN_GPIO_Port GPIOB
